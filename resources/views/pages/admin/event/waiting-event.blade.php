                ...
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <div class="card card-product">
                                        ...
                                        <div class="card-footer">
                                            <div class="stats pull-left">
                                                <p class="category"><i class="material-icons">room</i> {{ $event->city_name }} </p>
                                            </div>
                        ...
                        <div class="row center">
                            <div class="col-md-2 ml-auto mr-auto loading loading-center">
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('js/events/waiting.js') }}"></script>
@endsection
