...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    initMaterialWizard: function(){
        ...
        $("#event-picture0").change(function(){
            readURL(this);
        });
        $("#event-picture1").change(function(){
            readURL(this,'.event-picture1');
        });
        $("#event-picture2").change(function(){
            readURL(this,'.event-picture2');
        });
        $("#event-picture3").change(function(){
            readURL(this,'.event-picture3');
        });
        ...
        function readURL(input, previewClass = '.preview_image') {
            if (input.files && input.files[0]) {
                var reader = new FileReader();

                reader.onload = function (e) {
                    $(previewClass).attr('src', e.target.result).fadeIn('slow');
                }
    ...
    initDashboardPageCharts: function(){
        if( $('#dailySalesChart').length != 0 && $('#completedTasksChart').length != 0 && $('#websiteViewsChart').length != 0 ){
            ...
            var dataWebsiteViewsChart = {
                ...
                series: [
                    [400, 200, 600, 200, 200, 400, 600, 600, 500, 300, 800, 700]
    ...
    showSwal: function(type){
        if(type == 'basic'){
            ...
            swal({
                title: "Successful!",
                text: "Your Event has been build!",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                type: "success"
            }).catch(swal.noop)
            ...
            swal({
                title: "Successful!",
                text: "Your Event has been not build!",
                buttonsStyling: false,
